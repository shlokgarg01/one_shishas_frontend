    ...
    <View
      ...
      <View>
        <View style={{width: device_width, height: device_height * 0.4}}>
          <Image
            source={require('../../assets/Images/Basic/cinnamon_gum.png')}
            resizeMode="cover"
        ...
        <Text style={{paddingHorizontal: 34, fontSize: 25, marginVertical: 10}}>
          Gum with real cinnamon
        </Text>
        {/* <Text style={{paddingHorizontal: 40, fontSize: 40, marginTop: 20}}>
          Vanilla, Pan & Spring water
        </Text> */}
        <Text style={{paddingHorizontal: 34, fontSize: 25}}>
          A fiery long lasting flavour
        </Text>
      </View>
      <View>
        <View
        ...
        <View
          ...
          <Image
            ...
            source={require('../../assets/Ratings/cinnamon_gum.png')}
          />
        </View>
      </View>
    </View>
