    ...
    <View
      ...
      <View>
        <View style={{width: device_width, height: device_height * 0.4}}>
          <Image
            source={require('../../assets/Images/Basic/cola_lemon.jpeg')}
            resizeMode="cover"
        ...
        <Text style={{paddingHorizontal: 40, fontSize: 25, marginTop: 20, marginBottom: 10}}>
          Cola with a hint of citrus
        </Text>
      ...
      <View>
        ...
        <View
          ...
          <Image
            ...
            source={require('../../assets/Ratings/cola_lemon.png')}
          />
        </View>
      </View>
    </View>
