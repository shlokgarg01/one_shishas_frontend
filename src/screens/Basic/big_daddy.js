    ...
    <View
      ...
      <View>
        <View style={{width: device_width, height: device_height * 0.4}}>
          <Image
            source={require('../../assets/Images/Basic/big_daddy.jpeg')}
            resizeMode="cover"
        ...
        <Text style={{paddingHorizontal: 40, fontSize: 25, marginVertical: 10}}>
          Cigar with complementing
        </Text>
        <Text style={{paddingHorizontal: 40, fontSize: 25,  marginBottom: 10}}>
          flavours for the perfect blend
        </Text>
      ...
      <View>
        ...
        <View
          ...
          <Image
            ...
            source={require('../../assets/Ratings/big_daddy.png')}
          />
        </View>
      </View>
    </View>
